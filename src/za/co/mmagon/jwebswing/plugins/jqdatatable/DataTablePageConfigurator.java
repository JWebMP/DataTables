...
public class DataTablePageConfigurator extends PageConfigurator
{
	...
	public Page configure(Page page)
	{
		if (!page.isConfigured())
		{
			...
			page.getBody().addJavaScriptReference(DataTableReferencePool.JQueryDataTablesUI.getJavaScriptReference());
			
			
			page.getBody().addCssReference(DataTableReferencePool.JQueryDataTables.getCssReference());
			page.getBody().addCssReference(DataTableReferencePool.JQueryDataTablesUI.getCssReference());
		}
		return page;
	}
